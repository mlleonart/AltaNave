// Función para renderizar la ficha del coche
    ...
    return `
      	        ...
      	        <div class="card">
          	        <div class="badge" style="background-color: ${car.badgeColor};">${car.tipo}</div>
                   	<a title="Porsche 911 GT2 RS  Coupé" href="${car.imagen}">
                    	<picture>
  ...
  // Función para cargar los datos desde GitHub y filtrar por ID
  ...
  // Cargar la ficha del coche con ID 2 (ejemplo: Porsche 911 Carrera 4)
//  loadCarData(2);
